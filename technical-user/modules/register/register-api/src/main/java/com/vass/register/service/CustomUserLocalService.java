...
public interface CustomUserLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.vass.register.service.impl.CustomUserLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the custom user local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link CustomUserLocalServiceUtil} if injection and service tracking are not available.
	 */
